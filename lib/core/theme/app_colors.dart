...
/// This class provides static access to color constants for both themes.
/// For theme-aware colors, use the extension methods on BuildContext: context.appColors
class AppColors {
  // ==================== DARK THEME ====================
