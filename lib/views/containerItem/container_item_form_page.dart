...
//   @override
//   _ContainerItemFormPageState createState() =>
//       _ContainerItemFormPageState();
// }
...
//       // Pop only once if coming from RoomDetailScreen, otherwise pop twice (to go back to home)
//       if (widget.fromRoomDetailScreen) {
//         Navigator.pop(context);
//       } else {
//         Navigator.pop(context);
...
//           content: Text(
//             widget.isAddItemScreen
//                 ? 'Item "$containerName" added to ${widget.room.name}'
//                 : 'Container "$containerName" added to ${widget.room.name}',
//           ),
//           backgroundColor: AppColors.primary,
//           behavior: SnackBarBehavior.floating,
